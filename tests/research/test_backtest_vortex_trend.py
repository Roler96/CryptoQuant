"""Tests for VortexTrend strategy."""
...
from research.backtest_vortex_trend import VortexTrend
...
def test_vortex_trend_values_are_valid():
...
def test_vortex_trend_detects_uptrend():
...
def test_vortex_trend_detects_downtrend():
...
def test_vortex_trend_no_nan_in_output():
...
def test_vortex_trend_min_bars_enforced():
