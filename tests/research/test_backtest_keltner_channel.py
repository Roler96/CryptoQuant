"""Tests for KeltnerChannelTrend strategy."""
...
class TestKeltnerChannelTrend:
    """Tests for the KeltnerChannelTrend strategy class."""

    def test_import(self):
        """Strategy module imports without error."""
        from research.backtest_keltner_channel import KeltnerChannelTrend
        assert KeltnerChannelTrend is not None
