...
from research.backtest_dmi_trend import DMITrend
...
def test_dmi_trend_returns_pandas_series():
...
def test_dmi_trend_values_are_valid():
...
def test_dmi_trend_detects_uptrend():
...
def test_dmi_trend_detects_downtrend():
...
def test_dmi_trend_no_nan_in_output():
...
def test_dmi_trend_min_bars_enforced():
