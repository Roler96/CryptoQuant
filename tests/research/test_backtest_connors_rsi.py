"""Tests for ConnorsRSITrend strategy."""
...
class TestConnorsRSITrend:
    """Tests for the ConnorsRSITrend strategy class."""

    def test_import(self):
        """Strategy module imports without error."""
        from research.backtest_connors_rsi import ConnorsRSITrend
        assert ConnorsRSITrend is not None
