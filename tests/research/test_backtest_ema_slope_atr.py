"""Tests for EMASlopeATR strategy."""
...
class TestEMASlopeATR:
    """Tests for the EMASlopeATR strategy class."""

    def test_import(self):
        """Strategy module imports without error."""
        from research.backtest_ema_slope_atr import EMASlopeATR
        assert EMASlopeATR is not None
