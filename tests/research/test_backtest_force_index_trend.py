"""Tests for ForceIndexTrend strategy."""
import numpy as np
import pandas as pd
import pytest

from cryptoquant.exceptions import StrategyError
from research.backtest_force_index_trend import ForceIndexTrend
...
def _make_strong_uptrend_df(n: int = 500) -> pd.DataFrame:
    """Create data with strong uptrend + rising volume to trigger FI long."""
    dates = pd.date_range("2024-01-01", periods=n, freq="1h")
    ...
    # Higher volume on uptrend bars to amplify Force Index
...
class TestForceIndexTrend:
    ...
    def test_custom_params_instantiation(self):
        ...
        s = ForceIndexTrend(params={"fi_period": 20, "trend_period": 100})
        assert s.params["fi_period"] == 20
