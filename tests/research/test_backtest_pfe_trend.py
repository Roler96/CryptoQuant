"""Tests for PFETrend strategy."""
import numpy as np
import pandas as pd
import pytest

from cryptoquant.exceptions import StrategyError
from research.backtest_pfe_trend import PFETrend
...
def _make_strong_uptrend_df(n: int = 500) -> pd.DataFrame:
    """Create data with strong uptrend for PFE crossover testing."""
    dates = pd.date_range("2024-01-01", periods=n, freq="1h")
...
class TestPFETrend:
    ...
    def test_custom_params_instantiation(self):
        ...
        s = PFETrend(params={"pfe_period": 20, "trend_period": 100})
        assert s.params["pfe_period"] == 20
