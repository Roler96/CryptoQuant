...
class TestCheck:
    ...
    def test_unhealthy_data(self):
        ...
        df = pd.DataFrame(
            {
                "open": [100, 100, 100, 100, 100, 100, 100, 103],
                "high": [101, 101, 101, 101, 101, 101, 101, 104],
                "low": [99, 99, 99, 99, 99, 99, 99, 102],
                "close": [100, 100, 100, 100, 100, 100, 100, 103],
                "volume": [1000, 1000, 1000, 1000, 1000, 1000, 1000, 50000],
            },
            index=dates,
        )
        checker = DataQualityChecker(df)
